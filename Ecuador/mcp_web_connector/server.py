#!/usr/bin/env python3
"""MCP server for read/write access to the Media Commerce Ecuador web hosting."""
    ...
    def from_env(cls) -> "Settings":
        ...
        allowed_roots = tuple(
            ...
            for item in os.getenv(
                ...
                "/home,/var/www,/usr/local/apache/htdocs",
            ).split(",")
            if item.strip()
        )
        return cls(
            ssh_host=os.getenv("MCP_WEB_SSH_HOST", "51.79.104.194"),
            ...
            db_name=os.getenv("MCP_WEB_DB_NAME", ""),
            db_user=os.getenv("MCP_WEB_DB_USER", ""),
    ...
    if method == "initialize":
        ...
        return response(
            message_id,
            {
                ...
                "serverInfo": {"name": "mcecuador-web", "version": "0.1.0"},
            },
        )
