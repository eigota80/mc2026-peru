...
$smtpUsername = getenv('MC_SMTP_USERNAME') ?: 'ventas@mcperu.pe';
$smtpPassword = getenv('MC_SMTP_PASSWORD') ?: '';
$fromAddress = getenv('MC_SMTP_FROM') ?: $smtpUsername;
$recipientAddress = getenv('MC_CONTACT_RECIPIENT') ?: 'ventas@mcperu.pe';
$ccAddress = getenv('MC_CONTACT_CC') ?: 'ventas@mcperu.pe';
		...
		$mail->SetFrom($fromAddress, 'Media Commerce Perú');
